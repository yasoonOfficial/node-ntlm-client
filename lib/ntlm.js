...
function createType3Message(type2Message, username, password, workstation, target) {
	...
	if (type2Message.version === 2) {
		...
		let ntlmHash = (password.type === 'plain' ? hash.createNTLMHash(password) : password.ntlmHash),
		...
		let lmHash = (password.type === 'plain' ? hash.createLMHash(password) : password.lmHash),
			ntlmHash = (password.type === 'plain' ? hash.createNTLMHash(password) : password.ntlmHash),
